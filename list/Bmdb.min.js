...
var r="undefined"!=typeof self?self:"undefined"!=typeof window?window:void 0!==e?e:{},n=Object.create(r),i=/["&'<>]/;n.$escape=function(t){return function(t){var e=""+t,r=i.exec(e);if(!r)return t;var n="",o=void 0,a=void 0,s=void 0;for(o=r.index,a=0;o<e.length;o++){switch(e.charCodeAt(o)){case 34:s="&#34;" ;break;case 38:s="&#38;" 39:s="&#39;" 60:s="&#60;" 62:s="&#62;" ;break;default:continue}a!="=o&&(n+=e.substring(a,o)),a=o+1,n+=s}return" a!="=o?n+e.substring(a,o):n}(function" t(e){"string"!="typeof" e&&(e="null==e?"":"function"==typeof" e?t(e.call(e)):json.stringify(e));return e}(t))},n.$each="function(t,e){if(Array.isArray(t))for(var" r="0,n=t.length;r<n;r++)e(t[r],r);else" for(var i in t)e(t[i],i)},t.exports="n}).call(this,r(5))},function(t,e,r){},function(t,e,r){"use" strict";r.r(e);var n="r(0),i=r.n(n),o=r(7),a=r.n(o);var" s="{get:function(t){try{var" e="window.localStorage.getItem(t);if(e){var" r}}catch(t){}return[]},set:function(t,e){try{window.localstorage.setitem(t,json.stringify(e))}catch(t){}}},c="{API_BASE_URL:"https://bm.weajs.com/api/",DB_BASE_URL:"https://m.douban.com/movie/subject/",STARRED:"starred"},u=r(1),l=r.n(u);var" f="{param2object:function(t){var" e;var r.length>0&&r.forEach(function(t){var r=t.split("=");if(r.length>0){var n=r[1];e[r[0]]=l()(n)?"":decodeURIComponent(n)}}),e},object2param:function(t){var e=[],r=Object.keys(t);return r.length>0&&r.forEach(function(r){e.push(r+"="+t[r])}),e.join("&")}};function d(){return(d=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var 0="==u||!!u,this.categoryFilters=l||[],this.showCategories="movies"===e&&!!a,this.cache=void" r="arguments[e];for(var" n in r)object.prototype.hasownproperty.call(r,n)&&(t[n]="r[n])}return" t}).apply(this,arguments)}var p="r(8),h=r.n(p),v=r(9),b=r.n(v),g=function(){function" t(t){this.app="t,this.app.showCategories&&(this.apiUrl=this.app.apiUrl+"/categories",this.cacheKey=(this.app.namespace+"_categories").toUpperCase(),this.location=this.parseLocation(),this.app.category=this.location.query[this.cacheKey],this.$container=i()(h()()).prependTo(this.app.$container),this.$list=this.$container.find("ul"),this.getData())}var" e="t.prototype;return" e.parselocation="function(){var" t="window.location;return{href:t.href,origin:t.origin+t.pathname,query:this.app.urlParam.param2object(t.search)}},e.getData=function(){var" t.includes(e)})).map(function(t){var e,r="this.location,n=r.origin,i=r.query;return" n+"?"+this.app.urlparam.object2param(d({},i,((e="{})[this.cacheKey]=encodeURIComponent(t),e)))},t}(),y=function(t){new" g(t)},m="r(10),w=r.n(m),j=r(11),x=r.n(j),$=function(){function" t(t){var 0,this.showstarred="void" e.setviews="function(){this.$container.append(w()({darkMode:this.darkMode,skeletons:Array.from({length:this.skeletonNum})})),this.darkMode&&this.$container.addClass("bmdb-dark-mode"),this.$list=this.$container.find(".bmdb-list" .bmdb-ul"),this.$loader="this.$container.find(".bmdb-loader")},e.bindScrollEvent=function(){var">this.$loader.offset().top&&this.getData()},e.getData=function(){var t=this;if(!this.isLoading){this.isLoading=!0;var e=this.cache&&1===this.page;if(e){this.cacheKey=this.category?this.namespace+":"+this.category:this.namespace;var r=this.store.get(this.cacheKey);this.render(r)}var n={page:this.page,limit:this.limit,secret:this.secret};this.category&&(this.category===c.STARRED?n.starred=!0:n.category=this.category),i.a.ajax({url:this.apiUrl,data:n,dataType:"json",success:function(r){r.length<t.limit&&(t.setNoMoreDataView(),t.offScrollEvent()),e&&(t.$list.html(""),t.store.set(t.cacheKey,r)),t.render(r),t.page+=1,t.isLoading=!1},error:function(e){t.isLoading=!1,console.error("[BMDB]",e)}})}},e.render=function(t){t.length>0&&(t=t.map(function(t){var e=Math.round(t.rating/2);return t.doubanUrl=""+c.DB_BASE_URL+t.doubanId,t.stars=Array.from({length:5}).map(function(t,r){return r+1</t.limit&&(t.setNoMoreDataView(),t.offScrollEvent()),e&&(t.$list.html(""),t.store.set(t.cacheKey,r)),t.render(r),t.page+=1,t.isLoading=!1},error:function(e){t.isLoading=!1,console.error("[BMDB]",e)}})}},e.render=function(t){t.length></arguments.length;e++){var></e.length;o++){switch(e.charCodeAt(o)){case></https:></0||g&&t-v>