...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdexchange.com\/a\/display.php?r=968519&treqn=314526433&runauction=1&crr=99d87fc8309715a542ce,IQJRZUDbbbdfa5928ca50b849b2&rtid=5e7c183b3fd14");
var url = builder.build();
 ...
 + 'sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5e7c183b3fd14" frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5e7c183b3fd14').removeAttribute('sandbox');
    }
