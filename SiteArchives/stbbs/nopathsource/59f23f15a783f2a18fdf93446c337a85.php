...
var builder = new ReopenUrlBuilder("https:\/\/www.geniusdexchange.com\/a\/display.php?r=968501&treqn=1562877045&runauction=1&crr=53f095c151bdcce8586f,Q1cHAxW9a04b9cd76b92bc5f7ff&rtid=5e7c183bee76a");
var url = builder.build();
 ...
 + 'sandbox="allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-pointer-lock allow-same-origin" id="5e7c183bee76a" frameborder="0" src="'+ url +'" scrolling="no"></iframe>';
    ...
    if ((browser.chrome && browser.major_version < 17) || browser.opera_mini) {
        document.getElementById('5e7c183bee76a').removeAttribute('sandbox');
    }
